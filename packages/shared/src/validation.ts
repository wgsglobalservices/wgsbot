...
export const defaultRecapPrompt = [
  ...
  "Generate a WGS / MinutesBot meeting recap using the resolved meeting type template. For Weekly Sales, use these sections: 1. Weekly Summary, 2. Key Wins and Progress, 3. Sales Pipeline and Customer Follow-Up, 4. Staffing and Operations, 5. Revenue, Forecast, and Reporting, 6. CRM and Tracking, 7. Pricing and Contract Discussion, 8. Decisions Made, 9. Action Items, 10. Risks and Blockers, 11. Open Questions.",
  ...
  "For standard recaps, group notes into the selected template sections and preserve important meeting metadata such as meeting title, date, and weekly focus when stated.",
