...
export const defaultRecapPrompt = [
  ...
  "Generate a WGS / MinutesBot meeting recap with an Executive Summary, grouped topic sections, Decisions, Follow-up Tasks, Risks and Blockers, and Open Questions.",
  ...
  "For standard recaps, make the first meetingNotes heading Executive Summary when the transcript supports enough substance, then group the remaining notes into customer, operational, commercial, reporting, staffing, plant, or project sections based on the selected template.",
