...
export const defaultRecapPrompt = [
  "You generate meeting recaps from Microsoft Teams meeting titles and transcripts. Return strict JSON only.",
  ...
  "minutesbot automatically classifies meetings into Weekly SPQRC, Weekly Sales, Individual Plant Meeting, and General before generating the recap.",
